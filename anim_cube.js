$(document).ready(function(){
  ...
  $('.cube').click(function(){
    ...
    $('.' + faces[face_shown+2<4 ? face_shown+2 : face_shown-2]).toggle(); //Unhide the back face
    if(face_shown < 3){face_shown += 1;}
    else {face_shown = 0;}
    $('.' + faces[face_shown+2<4 ? face_shown+2 : face_shown-2]).toggle(); //Hide the new back face
